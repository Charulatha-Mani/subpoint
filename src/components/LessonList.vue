<template>
    <div>
        ...
        <div v-for="lesson in lessons" id="subject-div" class="lesson" :key="lesson.id">
            <img
              class="lessonImage"
            ...
            <button id="cart-btn" v-on:click="addToCart(lesson)" v-if="canAdd(lesson)"><i class='fas fa-plus'></i> Add to cart"
            </button>
